...
//			return;
   ...
   */
	public function showAction()
	{
    	...
    	$local_file_path = USVN_SVNUtils::getRepositoryFileUrl($config->subversion->path."/svn/".$project_name."/".$svn_file_path);
   ...
   */
	public function commitAction()
	{
		...
		$config = new USVN_Config_Ini(USVN_CONFIG_FILE, USVN_CONFIG_SECTION);
		$project_name = str_replace(USVN_URL_SEP, '/',$this->_project->name);
		$local_project_path = USVN_SVNUtils::getRepositoryFileUrl($config->subversion->path."/svn/".$project_name."/");
