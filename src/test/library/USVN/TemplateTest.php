 ...
 */
class USVN_TemplateTest extends USVN_Test_TestCase
{
    /**
    ...
    {
		USVN_Template::initTemplate('usvn', 'public/medias');
		$this->assertEquals('usvn', USVN_Template::getTemplate());
	}
	...
	public function test_listTemplate()
	{
		...
		$this->assertTrue(in_array('usvn', $list));
	...
	{
		$this->assertTrue(USVN_Template::isValidTemplateDirectory('public/medias/usvn'));
		$this->assertFalse(USVN_Template::isValidTemplateDirectory('public/medias/usvn/.svn'));
		$this->assertFalse(USVN_Template::isValidTemplateDirectory('public/medias/usvn/.htaccess'));
	}
}
