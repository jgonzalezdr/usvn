...
define( 'HTPASSWD_FILE',  TESTING_DIR."/htpasswd" );

/**
 * Test class for USVN_ImportHtpasswd.
 * Generated by PHPUnit_Util_Skeleton on 2007-04-03 at 09:22:11.
 */
class USVN_ImportHtpasswdTest extends USVN_Test_DBTestCase
{
    /**
	...
	{
		file_put_contents(HTPASSWD_FILE, "noplay:lQeKGl9L6sH3M\nbibi:9bhJwNgJ00I6E\n");
		$import = new USVN_ImportHtpasswd(HTPASSWD_FILE);
	...
	{
		file_put_contents(HTPASSWD_FILE, "");
		$import = new USVN_ImportHtpasswd(HTPASSWD_FILE);
	...
	{
		file_put_contents(HTPASSWD_FILE, "noplay\nbibi:9bhJwNgJ00I6E");
		try {
			$import = new USVN_ImportHtpasswd(HTPASSWD_FILE);
		}
	...
	{
		file_put_contents(HTPASSWD_FILE, "noplay:f:f\nbibi:9bhJwNgJ00I6E");
		try {
			$import = new USVN_ImportHtpasswd(HTPASSWD_FILE);
		}
		catch (USVN_Exception $e) {
	...
	{
		file_put_contents(HTPASSWD_FILE, "noplay:test\nnoplay:tutu\nbibi:9bhJwNgJ00I6E");
		try {
			$import = new USVN_ImportHtpasswd(HTPASSWD_FILE);
		}
		catch (USVN_Exception $e) {
	...
	public function test_updateUser()
	{
		file_put_contents(HTPASSWD_FILE, "noplay:lQeKGl9L6sH3M\nbibi:9bhJwNgJ00I6E");
		$import = new USVN_ImportHtpasswd(HTPASSWD_FILE);
		file_put_contents(HTPASSWD_FILE, "noplay:BD3ZmTBhHmWJs\nbibi:9bhJwNgJ00I6E\njames:hkjfhdjk");
		$import = new USVN_ImportHtpasswd(HTPASSWD_FILE);
		$userTable = new USVN_Db_Table_Users();
